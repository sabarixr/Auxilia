...
MUMBAI_ZONES = [
    {"id": "andheri-east", "name": "Andheri East", "lat": 19.1136, "lon": 72.8697, "risk": "medium"},
    {"id": "andheri-west", "name": "Andheri West", "lat": 19.1364, "lon": 72.8296, "risk": "medium"},
    {"id": "bandra-west", "name": "Bandra West", "lat": 19.0596, "lon": 72.8295, "risk": "low"},
    {"id": "bandra-east", "name": "Bandra East", "lat": 19.0587, "lon": 72.8482, "risk": "medium"},
    {"id": "powai", "name": "Powai", "lat": 19.1176, "lon": 72.9060, "risk": "low"},
    {"id": "kurla", "name": "Kurla", "lat": 19.0726, "lon": 72.8845, "risk": "high"},
    {"id": "dadar", "name": "Dadar", "lat": 19.0178, "lon": 72.8478, "risk": "high"},
    {"id": "lower-parel", "name": "Lower Parel", "lat": 19.0047, "lon": 72.8305, "risk": "medium"},
    {"id": "malad-west", "name": "Malad West", "lat": 19.1872, "lon": 72.8484, "risk": "medium"},
    {"id": "goregaon-east", "name": "Goregaon East", "lat": 19.1663, "lon": 72.8526, "risk": "medium"},
    {"id": "borivali-west", "name": "Borivali West", "lat": 19.2307, "lon": 72.8567, "risk": "low"},
    {"id": "thane-west", "name": "Thane West", "lat": 19.2183, "lon": 72.9781, "risk": "medium"},
    {"id": "vashi", "name": "Vashi", "lat": 19.0771, "lon": 72.9986, "risk": "low"},
    {"id": "churchgate", "name": "Churchgate", "lat": 18.9322, "lon": 72.8264, "risk": "high"},
    {"id": "colaba", "name": "Colaba", "lat": 18.9067, "lon": 72.8147, "risk": "medium"},
]
...
async def seed_claims(session: AsyncSession, policies: list, riders: list, trigger_events: list) -> list:
    ...
    # Create 60-80 claims
    num_claims = random.randint(60, 80)
